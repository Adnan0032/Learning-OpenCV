...
yolo_weights = "D:/yolo/darknet/yolov3.weights"
yolo_cfg = "D:/yolo/darknet/cfg/yolov3.cfg"
coco_names = "D:/yolo/darknet/data/coco.names"
...
net = cv2.dnn.readNet(yolo_weights, yolo_cfg) #o tiny é uma versao mais leve
